package br.com.simplecrud.unit.mapper;
...
class MapperTest {
    ...
    void parseEntityListToDTOListTest() {
        List<PersonDTO> outputList = Mapper.parseObjects(inputObject.mockEntityList(), PersonDTO.class).get();
    ...
    void parserDTOListToEntityListTest() {
        List<Person> outputList = Mapper.parseObjects(inputObject.mockDTOList(), Person.class).get();
